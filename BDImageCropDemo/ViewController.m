...
@interface ViewController ()<UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIActionSheetDelegate, BDImageCropperDelegate>
...
- (void)imageCropper:(BDImageCropViewController *)cropperViewController didFinished:(UIImage *)editedImage {
    ...
    [cropperViewController dismissViewControllerAnimated:YES completion:^{
        [self.headButton setBackgroundImage:editedImage forState:UIControlStateNormal];
    }];
}
